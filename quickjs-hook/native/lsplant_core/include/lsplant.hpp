...
/// \brief Hook a Java method using raw ArtMethod pointers.
/// \param[in] target_art_method The original ArtMethod to hook.
/// \param[in] hook_art_method The replacement ArtMethod to route into.
/// \param[in] backup_art_method Writable ArtMethod storage used as LSPlant backup.
/// \return Indicate whether the hook succeeded.
[[nodiscard, maybe_unused, gnu::visibility("default")]] bool HookRaw(void *target_art_method,
                                                                     void *hook_art_method,
                                                                     void *backup_art_method);

/// \brief Unhook a Java method that was previously hooked through #HookRaw().
[[nodiscard, maybe_unused, gnu::visibility("default")]] bool UnHookRaw(void *target_art_method);

/// \brief Check whether a raw ArtMethod pointer is currently hooked by LSPlant.
[[nodiscard, maybe_unused, gnu::visibility("default")]] bool IsHookedRaw(void *art_method);

/// \brief Deoptimize a Java method using a raw ArtMethod pointer.
[[nodiscard, maybe_unused, gnu::visibility("default")]] bool DeoptimizeRaw(void *art_method);
